...
func Setup(app *fiber.App) {
	...
	com.Get("/all/paginate/subarea/:subarea_uuid", commune.GetPaginatedCommunesBySubAreaUUID)
	...
	posf.Get("/all/paginate/province/:asm_uuid", posform.GetPaginatedPosFormProvine)
	posf.Get("/all/paginate/area/:sup_uuid", posform.GetPaginatedPosFormArea)
